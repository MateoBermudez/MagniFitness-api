...
public class SecurityConfig {
     ...
     */
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter, UserService userService, JwtService jwtService, TwoFactorAuthFilter twoFactorAuthFilter) throws Exception {
        return http
